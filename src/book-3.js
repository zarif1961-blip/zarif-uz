// src/book-3.js
// Контент страницы книги 3 (без шапки, подвала и переводчика)

export default `
  <!-- ===== УНИКАЛЬНЫЕ СТИЛИ ДЛЯ КНИГИ 3 ===== -->
  <style>
  ...
  <div class="hero-book">
    <div class="hero-inner">
      ...
      <div class="hero-text">
        <div class="badge-book">ZARIF 2025 — BOOK 3</div>
        <div class="hero-subtitle-book">ZARIF 2025 — WORLD'S FIRST IDEAL SEWING TECHNOLOGY BASED ON A ROTATING LOOPER</div>
        <h1>ZARIF 2025 AS A BASIS FOR THE INTEGRATION OF HUMANOID ROBOTS AND THE CREATION OF AUTONOMOUS, UNMANNED SEWING PRODUCTIONS OF THE FUTURE</h1>
  ...
  <div class="container-book">
    <div class="info-section">
      ...
      <p style="font-size:14px; color:#a0b8d0; line-height:1.8; margin-bottom:16px;">This is the <strong style="color:#e8f4ff;">third book</strong> in the series <strong style="color:#c9a227;">«ZARIF 2025 — The Autonomous Sewing Production Platform»</strong>. It is a <strong style="color:#e8f4ff;">comprehensive book about how the ZARIF 2025 technology can become the machine foundation for the future autonomous sewing production</strong>, where the human role gradually transitions from manual execution of operations to task setting, engineering control, and strategic management. The main theme is the <strong style="color:#c9a227;">integration of four elements into a single production platform</strong>: the ideal sewing technology ZARIF 2025, digital control at the machine level, humanoid robot operators, and autonomous internal logistics.</p>
      ...
      <div class="two-columns">
        <div>
          ...
          <ul class="features" style="margin-bottom:0;">
            <li>Why traditional sewing machines are <strong style="color:#e8f4ff;">incompatible with humanoid robots</strong> — 10 defects of Lockstitch and 4 flaws of Chain Stitch.</li>
            <li>The <strong style="color:#e8f4ff;">seven mandatory requirements</strong> of a humanoid robot for a sewing machine — and why only ZARIF 2025 satisfies them.</li>
            ...
            <li>The <strong style="color:#e8f4ff;">Anti-Deflection algorithm</strong> — how AI prevents needle breakage on thickened seams.</li>
            <li><strong style="color:#e8f4ff;">ZARIF Robo-Carts</strong> — decentralized logistics of the future with the double binding principle.</li>
            <li><strong style="color:#e8f4ff;">Lights-out production</strong> — 24/7 autonomous factory architecture and digital twin in NVIDIA Omniverse.</li>
            <li><strong style="color:#e8f4ff;">Economics of the autonomous factory</strong> — 75% OPEX reduction, 11.1-month payback.</li>
          </ul>
        </div>
        <div>
          <h3>🎯 Who Is This Book For?</h3>
          <ul class="who-list">
            <li><strong style="color:#e8f4ff;">Mechanical engineers and technologists</strong> of the sewing industry seeking solutions to automate production processes.</li>
            ...
            <li><strong style="color:#e8f4ff;">Physical AI and machine vision system developers</strong> looking for integration with sewing equipment.</li>
            <li><strong style="color:#e8f4ff;">Humanoid robot developers</strong> (Tesla, Figure AI, Boston Dynamics and similar).</li>
    ...
    <div class="cards">
      ...
      <div class="card">
        <div class="card-header free">
          ...
          <div class="card-title">Book 3 — Preview</div>
        ...
        <div class="card-body">
          ...
          <ul class="features">
            ...
            <li class="locked">Robotization protocols &amp; autonomous factory architecture (paid only)</li>
          </ul>
          <button class="btn btn-free" onclick="openExcerpt()">📄 Read Excerpt Online</button>
          <a class="btn-download" href="https://zarif1961-blip.github.io/zarif-books/ZARIF_2025_Book_3_EXCERPT.pdf" download>⬇ Download Excerpt (PDF)</a>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-header paid">
          ...
          <div class="card-title">Book 3 — Complete Edition</div>
        ...
        <div class="card-body">
          ...
          <ul class="features">
            <li>Full book — Integration of Humanoid Robots and Autonomous Sewing Production</li>
            <li>Diagnosis: 10 defects of Lockstitch + 4 flaws of Chain Stitch</li>
            <li>The $220 Million Failure — analysis of largest robotization failures</li>
            <li>Evolution: from ZARIF 1994 to ZARIF 2025</li>
            <li>Engineering architecture of the ideal machine (Dry Head, 17 criteria)</li>
            <li>Automatic thread trimming unit — continuous cycle technology</li>
            <li>The 360° circular sewing mechanism — the next frontier</li>
            <li>ZARIF Robo-Cart — decentralized logistics of the future</li>
            <li>Digital "nervous system": ROS 2, OPC UA, EtherCAT protocols</li>
            <li>Anti-Deflection algorithm — mathematics against breakage</li>
            <li>Lights-out production — 24/7 without shift personnel</li>
            <li>Economics: 11.1-month payback, $34.6M NPV over 10 years</li>
            <li>Strategic roadmap 2026–2035</li>
            <li>Investment proposal — Round A ($40–50M)</li>
          </ul>
  ...
  <div class="modal" id="excerptModal">
    <div class="modal-box">
      <div class="modal-head">
        <h3>📄 ZARIF 2025 — Book 3 Excerpt</h3>
  ...
  <script>
    var EXCERPT_PDF = "https://zarif1961-blip.github.io/zarif-books/ZARIF_2025_Book_3_EXCERPT.pdf";
    ...
    document.getElementById('plisioPayBtn').addEventListener('click', function() {
      ...
      var plisioUrl = PLISIO_BASE_URL + '?order_number=' + encodeURIComponent(email + '::book_3');
