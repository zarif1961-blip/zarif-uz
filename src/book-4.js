// src/book-4.js
// Контент страницы книги 4 (без шапки, подвала и переводчика)

export default `
  <!-- ===== УНИКАЛЬНЫЕ СТИЛИ ДЛЯ КНИГИ 4 ===== -->
  <style>
  ...
  <div class="hero-book">
    <div class="hero-inner">
      ...
      <div class="hero-text">
        <div class="badge-book">ZARIF 2025 — BOOK 4</div>
        <div class="hero-subtitle-book">ZARIF 2025 — WORLD'S FIRST IDEAL SEWING TECHNOLOGY BASED ON A ROTATING LOOPER</div>
        <h1>THE KEY MISSING LINK IN THE CREATION OF THE AUTONOMOUS, UNSTAFFED SEWING FACILITIES OF THE FUTURE</h1>
  ...
  <div class="container-book">
    <div class="info-section">
      ...
      <p style="font-size:14px; color:#a0b8d0; line-height:1.8; margin-bottom:16px;">This is the <strong style="color:#e8f4ff;">fourth book</strong> in the series <strong style="color:#c9a227;">«ZARIF 2025 — The Platform for Autonomous Sewing Production»</strong>. It brings together everything: the history of sewing thread and its role in civilisation, an analysis of the fundamental shortcomings of nineteenth-century technologies, a detailed description of a revolutionary invention, and — most importantly — the architecture of the world's first genuinely autonomous sewing factory. This book answers a question that has been troubling engineers, investors, and sewing enterprise managers for several decades now: why, with all the power of modern robotics and artificial intelligence at our disposal, does the sewing workshop remain a zone of manual labour? <strong style="color:#c9a227;">ZARIF 2025 is not an improvement upon existing technology. It is a paradigm shift. It is the missing link between humanoid robots and fully autonomous sewing production.</strong></p>
      
      <h3>👤 About the Author</h3>
      <p style="font-size:14px; color:#a0b8d0; line-height:1.8; margin-bottom:16px;"><strong style="color:#e8f4ff;">Zarif Sharifovich Tadjibaev</strong> is the first person in the world to invent, in 1994, the <strong style="color:#c9a227;">double thread chain stitch technology using a rotary looper</strong>, for which <strong style="color:#e8f4ff;">US Patent No. 6,095,069</strong> was issued in 2000. It took him approximately <strong style="color:#c9a227;">31 years</strong> to transform his technology into the <strong style="color:#e8f4ff;">world's first ideal sewing technology for single-line thread seams</strong>. The fourth book in the series delves deeper into the thread itself — from ancient sinews to modern nanofibres — and presents the complete architecture of the autonomous factory, proving why ZARIF 2025 is the key missing link in creating unmanned sewing facilities of the future.</p>
      
      <div class="two-columns">
        <div>
          <h3>🎯 What Will You Learn From This Book?</h3>
          <ul class="features" style="margin-bottom:0;">
            <li>The <strong style="color:#e8f4ff;">history of sewing thread</strong> — from sinew and cotton to nanofibres and smart threads for e-textiles.</li>
            <li><strong style="color:#e8f4ff;">Types of sewing thread and their role in automation</strong> — how thread choice affects autonomous production.</li>
            <li>Why <strong style="color:#e8f4ff;">threadless methods</strong> (ultrasound, glue, laser) cannot replace the classical thread seam.</li>
            <li>Why the single-line thread stitch (Type 301) is the <strong style="color:#e8f4ff;">absolute leader</strong> — and what its hidden vulnerabilities are.</li>
            <li>The <strong style="color:#e8f4ff;">10 irremediable defects of the Lockstitch (Type 301)</strong> — the "bobbin curse".</li>
            <li>The <strong style="color:#e8f4ff;">4 fundamental vices of the Chain Stitch (Type 401)</strong> — the "thread triangle" and its consequences.</li>
            <li>The <strong style="color:#e8f4ff;">ZARIF 2025 revolution</strong> — the rotary looper, 13 phases of ideal interlooping, and 10 revolutionary breakthroughs.</li>
            <li><strong style="color:#e8f4ff;">Physical AI</strong> — the brain and nervous system of the factory of the future.</li>
            <li>The <strong style="color:#e8f4ff;">ZARIF Smart Presser Foot</strong> — the machine's sensory nervous system.</li>
            <li><strong style="color:#e8f4ff;">Humanoid robots</strong> on the ZARIF 2025 platform and the ZARIF Robotic Trolley — the circulatory system of the factory.</li>
            <li><strong style="color:#e8f4ff;">Types of ZARIF 2025 industrial machines</strong> and pattern automats with 360° circular sewing mechanism.</li>
            <li>The <strong style="color:#e8f4ff;">economics of the autonomous factory</strong> — payback in 11 months, $34.6M NPV over 10 years.</li>
            <li>The <strong style="color:#e8f4ff;">$400–900 billion market opportunity</strong> and commercialisation strategy.</li>
          </ul>
        </div>
        <div>
          ...
          <ul class="who-list">
            ...
            <li><strong style="color:#e8f4ff;">Managers of manufacturing enterprises</strong> aiming to increase efficiency and reduce dependence on manual labour.</li>
            <li><strong style="color:#e8f4ff;">Investors</strong> in industrial automation, robotics and artificial intelligence.</li>
            <li><strong style="color:#e8f4ff;">Humanoid robot developers</strong> (Tesla, Figure AI, Boston Dynamics) looking for integration with sewing equipment.</li>
            <li><strong style="color:#e8f4ff;">Researchers in Physical AI and machine vision</strong> seeking real-world applications.</li>
            <li><strong style="color:#e8f4ff;">Digital production transformation specialists</strong> aiming for Industry 5.0.</li>
            ...
            <li><strong style="color:#e8f4ff;">All those who wish to understand</strong> what the industry of tomorrow will look like.</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card">
        <div class="card-header free">
          ...
          <div class="card-title">Book 4 — Preview</div>
        ...
        <div class="card-body">
          ...
          <ul class="features">
            ...
            <li>History of thread: from sinew to nanofibres</li>
            <li>Types, composition and classification of threads</li>
            <li class="locked">Full book (paid only)</li>
            <li class="locked">Autonomous factory architecture &amp; economics (paid only)</li>
          </ul>
          <button class="btn btn-free" onclick="openExcerpt()">📄 Read Excerpt Online</button>
          <a class="btn-download" href="https://zarif1961-blip.github.io/zarif-books/ZARIF_2025_Book_4_EXCERPT.pdf" download>⬇ Download Excerpt (PDF)</a>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-header paid">
          ...
          <div class="card-title">Book 4 — Complete Edition</div>
        ...
        <div class="card-body">
          ...
          <ul class="features">
            <li>Full book — The Key Missing Link in Creating Autonomous Sewing Facilities</li>
            <li>Complete history and evolution of sewing thread (Part I)</li>
            <li>10 irremediable defects of Lockstitch (Type 301) — the "bobbin curse"</li>
            <li>4 fundamental vices of Chain Stitch (Type 401) — the "thread triangle"</li>
            <li>The Digital Façade: Juki, Brother, Jack and their powerlessness</li>
            <li>$10 billion in annual losses — the price of illusion</li>
            <li>The graveyard of hope: $220 million in automation failures</li>
            <li>ZARIF 2025 revolution: rotary looper, 13 phases, 10 breakthroughs</li>
            <li>Physical AI: the brain and nervous system of the factory of the future</li>
            <li>ZARIF Smart Presser Foot — the machine's sensory nervous system</li>
            <li>Humanoid robots on ZARIF 2025 platform</li>
            <li>ZARIF Robotic Trolley — the circulatory system of the factory</li>
            <li>Types of ZARIF 2025 industrial machines</li>
            <li>Pattern automats with 360° circular sewing mechanism</li>
            <li>Economics of the autonomous factory: 11-month payback, $34.6M NPV</li>
            <li>$400–900 billion market opportunity</li>
            <li>Technical challenges without parallel, cell architecture, sceptic objections</li>
            <li>Documentary foundation and strategic roadmap 2026–2035</li>
          </ul>
  ...
  <div class="modal" id="excerptModal">
    <div class="modal-box">
      <div class="modal-head">
        <h3>📄 ZARIF 2025 — Book 4 Excerpt</h3>
  ...
  <script>
    var EXCERPT_PDF = "https://zarif1961-blip.github.io/zarif-books/ZARIF_2025_Book_4_EXCERPT.pdf";
    ...
    document.getElementById('plisioPayBtn').addEventListener('click', function() {
      ...
      var plisioUrl = PLISIO_BASE_URL + '?order_number=' + encodeURIComponent(email + '::book_4');
