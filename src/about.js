...
export default `
    ...
    <div class="wrap">
      ...
      <div class="founder-layout">
        <div class="founder-card">
          ...
          <div class="credential-item">
            <strong>PhD (2001):</strong> "Development and Justification of Parameters for Working Units of a Double Thread Chain Stitch Sewing Machine"
          </div>
          <div class="credential-item">
            <strong>20+ Years Academic Teaching:</strong> "Machine Parts", "Sewing Production Equipment", and "Patent Law" (master's level)
          </div>
  ...
  <section class="section" id="innovations">
    <div class="wrap">
      ...
      <div class="innovations-intro">
        <p>ZARIF 2025 does not improve on existing sewing technology — it replaces it. The current <strong>ZARIF 2025 prototype</strong> has practically validated the core mechanical breakthrough.</p>
      </div>
      <div class="inn-grid">
        <div class="inn-card">
          ...
          <p class="inn-desc">The world's first double-thread chain stitch formed by a continuously rotating looper with no eye-pointed looper.</p>
        </div>
        <div class="inn-card">
          <span class="inn-num">02</span>
          <span class="inn-icon">🧵</span>
          <div class="inn-name">Zero Bobbin — Continuous Thread Supply</div>
          <p class="inn-desc">Both top and bottom thread feed from 1–5 kg industrial cones. No bobbin depletion.</p>
        </div>
        <div class="inn-card">
          <span class="inn-num">03</span>
          <span class="inn-icon">⚖️</span>
          <div class="inn-name">Single Universal Tension Setting</div>
          <p class="inn-desc">One "Normal Tension" setting processes materials from 0.1 mm silk to 8 mm leather without any manual adjustment.</p>
        </div>
        <div class="inn-card">
          <span class="inn-num">04</span>
          <span class="inn-icon">📡</span>
          <div class="inn-name">Full Digital Control of Both Threads</div>
          <p class="inn-desc">The ZARIF architecture makes electronic control of both top and bottom thread tension geometrically possible.</p>
        </div>
        <div class="inn-card">
          <span class="inn-num">05</span>
          <span class="inn-icon">✅</span>
          <div class="inn-name">Guaranteed Zero Stitch Skips</div>
          <p class="inn-desc">100% loop capture reliability at any speed. The rotary looper geometry makes skips structurally impossible.</p>
        </div>
        <div class="inn-card">
          <span class="inn-num">06</span>
          <span class="inn-icon">🔇</span>
          <div class="inn-name">Vibration-Free Rotary Motion</div>
          <p class="inn-desc">The continuously rotating looper moves in one direction only — no oscillating hook mechanism, no vibrational stress.</p>
        </div>
        <div class="inn-card">
          <span class="inn-num">07</span>
          <span class="inn-icon">🪡</span>
          <div class="inn-name">Zero Thread Breaks from Machine Mechanics</div>
          <p class="inn-desc">ZARIF 2025 has no eye-pointed looper. Thread fatigue from machine mechanics is eliminated by design.</p>
        </div>
        <div class="inn-card">
          <span class="inn-num">08</span>
          <span class="inn-icon">🔩</span>
          <div class="inn-name">Zero Needle Breakage from Looper Collision</div>
          <p class="inn-desc">In ZARIF 2025, the looper's geometry makes needle collision mechanically impossible.</p>
        </div>
        <div class="inn-card">
          <span class="inn-num">09</span>
          <span class="inn-icon">🤖</span>
          <div class="inn-name">Native AI &amp; Robot Integration Architecture</div>
          <p class="inn-desc">The ZARIF mechanical design is architecturally compatible with EtherCAT real-time communication, 48 AI command types, and 10-channel sensor monitoring.</p>
        </div>
        <div class="inn-card">
          <span class="inn-num">10</span>
          <span class="inn-icon">🏭</span>
          <div class="inn-name">Dual-Operator Architecture</div>
          <p class="inn-desc">ZARIF 2025 machines work with equal efficiency under human operators and humanoid robots.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="cta-section" id="partnership">
    <div class="cta-inner">
      ...
      <p style="max-width:700px;margin:0 auto 36px;">We are raising Series A to establish <strong>ZARIF Sewing Technology Company</strong> in the United States.</p>
