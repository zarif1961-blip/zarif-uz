// src/book-2.js
// Контент страницы книги 2 (без шапки, подвала и переводчика)

export default `
  <!-- ===== УНИКАЛЬНЫЕ СТИЛИ ДЛЯ КНИГИ 2 ===== -->
  <style>
    /* Эти стили применяются только к странице книги 2 */
    .hero-book {
  ...
  <div class="hero-book">
    <div class="hero-inner">
      ...
      <div class="hero-text">
        <div class="badge-book">ZARIF 2025 — BOOK 2</div>
        <div class="hero-subtitle-book">ZARIF 2025 — WORLD'S FIRST IDEAL SEWING TECHNOLOGY BASED ON A ROTATING LOOPER</div>
        <h1>THE THREAD METHOD OF JOINING MATERIALS</h1>
        <h2>This is not the past — it is the foundation of the autonomous sewing industry of the future</h2>
  ...
  <div class="container-book">
    <div class="info-section">
      ...
      <p style="font-size:14px; color:#a0b8d0; line-height:1.8; margin-bottom:16px;">This is the <strong style="color:#e8f4ff;">second book</strong> in the series <strong style="color:#c9a227;">«ZARIF 2025 — The Autonomous Sewing Production Platform»</strong>. It is the <strong style="color:#e8f4ff;">world's first comprehensive guide</strong> to the revolutionary ZARIF 2025 sewing technology, which <strong style="color:#c9a227;">solves the 170-year-old problem of automating sewing production once and for all</strong>. This book explores the thread itself — from ancient sinews to modern high-tech fibers — and proves why thread remains the irreplaceable foundation of the autonomous sewing industry.</p>
      ...
      <div class="two-columns">
        <div>
          ...
          <ul class="features" style="margin-bottom:0;">
            <li>The <strong style="color:#e8f4ff;">36,000-year history of sewing thread</strong> — from animal sinews to smart threads for e-textiles.</li>
            <li>Why <strong style="color:#e8f4ff;">threadless methods</strong> (ultrasound, glue, laser) cannot fully replace the classic thread seam.</li>
            <li>How <strong style="color:#e8f4ff;">hybrid technologies</strong> combine the strength of thread and the hermetic sealing of welding.</li>
            <li>Why 3D printing, 3D knitting and 3D weaving <strong style="color:#e8f4ff;">will not replace the thread seam</strong> in multi-layer products.</li>
            <li>The <strong style="color:#e8f4ff;">ten irremovable defects of Lockstitch (Type 301)</strong> and <strong style="color:#e8f4ff;">four fundamental flaws of Chain Stitch (Type 401)</strong>.</li>
            <li>How <strong style="color:#e8f4ff;">ZARIF 2025 eliminates all these shortcomings</strong> — operating principles of the rotary looper, two-revolution kinematics, Dry Head architecture and digital control.</li>
          </ul>
        </div>
        <div>
    ...
    <div class="cards">
      ...
      <div class="card">
        <div class="card-header free">
          ...
          <div class="card-title">Book 2 — Preview</div>
        ...
        <div class="card-body">
          ...
          <ul class="features">
            ...
            <li>History of thread: from sinews to high-tech fibers</li>
          ...
          <a class="btn-download" href="https://zarif1961-blip.github.io/zarif-books/ZARIF_2025_Book_2_EXCERPT.pdf" download>⬇ Download Excerpt (PDF)</a>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-header paid">
          ...
          <div class="card-title">Book 2 — Complete Edition</div>
        ...
        <div class="card-body">
          ...
          <ul class="features">
            <li>Full book — The Thread Method of Joining Materials</li>
            <li>Complete history and evolution of sewing thread</li>
            <li>Analysis of threadless methods (ultrasound, glue, laser)</li>
            <li>Hybrid technologies: thread + welding</li>
            <li>Why 3D printing, 3D knitting, 3D weaving will not replace thread</li>
            <li>Ten irremovable defects of Lockstitch (Type 301)</li>
            <li>Four fundamental flaws of Chain Stitch (Type 401)</li>
            <li>ZARIF 2025 — complete solution</li>
            <li>Technical appendices &amp; glossary</li>
          </ul>
  ...
  <div class="modal" id="excerptModal">
    <div class="modal-box">
      <div class="modal-head">
        <h3>📄 ZARIF 2025 — Book 2 Excerpt</h3>
  ...
  <script>
    var EXCERPT_PDF = "https://zarif1961-blip.github.io/zarif-books/ZARIF_2025_Book_2_EXCERPT.pdf";
    ...
    document.getElementById('plisioPayBtn').addEventListener('click', function() {
      ...
      var plisioUrl = PLISIO_BASE_URL + '?order_number=' + encodeURIComponent(email + '::book_2');
