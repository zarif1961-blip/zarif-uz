// src/book-5.js
// Контент страницы книги 5 (без шапки, подвала и переводчика)

export default `
  <!-- ===== УНИКАЛЬНЫЕ СТИЛИ ДЛЯ КНИГИ 5 ===== -->
  <style>
  ...
  <div class="hero-book">
    <div class="hero-inner">
      ...
      <div class="hero-text">
        <div class="badge-book">ZARIF 2025 — BOOK 5</div>
        <div class="hero-subtitle-book">ZARIF 2025 — WORLD'S FIRST IDEAL SEWING TECHNOLOGY BASED ON A ROTATING LOOPER</div>
        <h1>INTEGRATION OF HUMANOID ROBOTS WITH SEWING MACHINES AND AUTOMATIC MACHINES BASED ON ZARIF 2025 TECHNOLOGY</h1>
        <h2>Creating autonomous, unmanned sewing factories of the future</h2>
  ...
  <div class="container-book">
    <div class="info-section">
      ...
      <p style="font-size:14px; color:#a0b8d0; line-height:1.8; margin-bottom:16px;">This is the <strong style="color:#e8f4ff;">fifth book</strong> in the series <strong style="color:#c9a227;">«ZARIF 2025 — The Platform for Autonomous Sewing Production»</strong>. It is the world's first comprehensive guide to the revolutionary ZARIF 2025 sewing technology, which resolves once and for all the 170-year-old problem of sewing automation. It describes in detail how the rotary looper technology, invented by Dr Zarif Tadjibaev, eliminates the fundamental shortcomings of traditional sewing machines (Types 301 and 401), making fully autonomous, unmanned garment production possible. The central theme of this book is the <strong style="color:#c9a227;">integration of humanoid robots with ZARIF 2025 machines</strong>. The author has developed <strong style="color:#e8f4ff;">three fundamentally different types of such integration</strong> — from the most complex (working with industrial machines) to the simplest (automated systems without templates). Each type has its own architecture, its own advantages, and its own technical requirements.</p>
      
      <h3>👤 About the Author</h3>
      <p style="font-size:14px; color:#a0b8d0; line-height:1.8; margin-bottom:16px;"><strong style="color:#e8f4ff;">Zarif Sharifovich Tadjibaev</strong> is the first person in the world to invent, in 1994, the <strong style="color:#c9a227;">double thread chain stitch technology using a rotary looper</strong>, for which <strong style="color:#e8f4ff;">US Patent No. 6,095,069</strong> was issued in 2000. It took him approximately <strong style="color:#c9a227;">31 years</strong> to transform his technology into the <strong style="color:#e8f4ff;">world's first ideal sewing technology for single-line thread seams</strong>. In this fifth book, Dr. Tadjibaev presents his comprehensive work on the integration of humanoid robots with ZARIF 2025 machines, describing three types of integration — from the most complex (working with industrial machines) to the simplest (automated systems without templates). The book also describes his key inventions from 2020–2025: the automatic thread-trimming technology, and the 360° circular sewing mechanism without rotation of the head.</p>
      
      <div class="two-columns">
        <div>
          <h3>🎯 What Will You Learn From This Book?</h3>
          <ul class="features" style="margin-bottom:0;">
            <li>Why traditional sewing machines (Types 301 and 401) are <strong style="color:#e8f4ff;">incompatible with robots</strong> — a detailed analysis of 11 fundamental defects of the lockstitch and 8 irresolvable problems of the chain stitch.</li>
            <li>How <strong style="color:#e8f4ff;">ZARIF 2025 technology eliminates all these defects</strong> — the operating principles of the rotary looper and ten revolutionary breakthroughs.</li>
            ...
            <li>The <strong style="color:#e8f4ff;">automatic thread-trimming assembly</strong> — continuous-cycle technology for 24/7 autonomy.</li>
            <li>The <strong style="color:#e8f4ff;">360° circular sewing mechanism</strong> — the next frontier for pattern automats without head rotation.</li>
            <li><strong style="color:#e8f4ff;">Digital control systems and the sensor complex</strong> — the "nervous system" of the smart machine.</li>
            <li>The <strong style="color:#e8f4ff;">Anti-Deflection algorithm</strong> — mathematics against breakages.</li>
            <li><strong style="color:#e8f4ff;">ZARIF Robotic Trolley</strong> — decentralised logistics of the future with the double-binding principle.</li>
            <li>Architecture of the <strong style="color:#e8f4ff;">ZARIF Autonomous Factory</strong> and the "Dual-Purpose" concept.</li>
            <li><strong style="color:#e8f4ff;">Economics of the autonomous factory</strong> — 75% OPEX reduction, 11.1-month payback, $34.6M NPV.</li>
            <li>The <strong style="color:#e8f4ff;">$400–900 billion market opportunity</strong> and commercialisation roadmap 2026–2035.</li>
          </ul>
        </div>
        <div>
          <h3>🎯 Who Is This Book For?</h3>
          <ul class="who-list">
            <li><strong style="color:#e8f4ff;">Mechanical engineers and technologists</strong> in the sewing industry seeking solutions for automating production processes.</li>
            ...
            <li><strong style="color:#e8f4ff;">OEM sewing equipment manufacturers</strong> seeking a technological breakthrough.</li>
            <li><strong style="color:#e8f4ff;">Digital production transformation specialists</strong> seeking pathways to Industry 5.0.</li>
    ...
    <div class="cards">
      ...
      <div class="card">
        <div class="card-header free">
          ...
          <div class="card-title">Book 5 — Preview</div>
        ...
        <div class="card-body">
          ...
          <ul class="features">
            ...
            <li>Diagnosis: why traditional sewing is incompatible with autonomy</li>
            <li>The birth of ZARIF 1994–2025</li>
            <li class="locked">Full book (paid only)</li>
            <li class="locked">Robot integration protocols &amp; autonomous factory architecture (paid only)</li>
          </ul>
          <button class="btn btn-free" onclick="openExcerpt()">📄 Read Excerpt Online</button>
          <a class="btn-download" href="https://zarif1961-blip.github.io/zarif-books/ZARIF_2025_Book_5_EXCERPT.pdf" download>⬇ Download Excerpt (PDF)</a>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-header paid">
          ...
          <div class="card-title">Book 5 — Complete Edition</div>
        ...
        <div class="card-body">
          ...
          <ul class="features">
            <li>Full book — Integration of Humanoid Robots with Sewing Machines and Automats</li>
            <li>Diagnosis: 11 defects of Lockstitch + 8 irresolvable problems of Chain Stitch</li>
            <li>$220 Million Wasted — analysis of automation failures</li>
            <li>Seven factory sections: where is the "bottleneck"?</li>
            <li>Birth of ZARIF 1994–2025: the question nobody asked</li>
            <li>The forgotten legacy: James Gibbs' rotary looper</li>
            <li>Current status: what has already been proved by the ZARIF 2025 prototype</li>
            <li>Anatomy of the rotary looper: two revolutions that changed everything</li>
            <li>Ten revolutionary breakthroughs of ZARIF 2025 technology</li>
            <li>Engineering architecture of the ideal machine (Dry Head, platforms, feed systems)</li>
            <li>Automatic thread-trimming assembly — continuous-cycle technology</li>
            <li>The 360° circular sewing mechanism — the next frontier</li>
            <li>Digital control systems and the sensor complex</li>
            <li>Integration architecture: three types — from complex to simple</li>
            <li>ZARIF Robotic Trolley — decentralised logistics of the future</li>
            <li>Architecture of the ZARIF Autonomous Factory</li>
            <li>The "Dual-Purpose" concept: human and robot</li>
            <li>Physical AI and ZARIF 2025: brain + nervous system + body</li>
            <li>The digital "nervous system": AI-to-AI protocols</li>
            <li>The "Anti-Deflection" algorithm — mathematics against breakages</li>
            <li>Integration with humanoid robots: technical documentation</li>
            <li>Industry 5.0: human-centred automation</li>
            <li>First markets: where ZARIF 2025 delivers maximum impact</li>
            <li>Economics of the autonomous factory: payback in 11.1 months</li>
            <li>Strategic market entry roadmap (2026–2035)</li>
            <li>Intellectual property strategy and global protection system</li>
            <li>Comparison with competitors: why ZARIF 2025 is in a league of its own</li>
            <li>Physical AI, humanoid robots, and the 2026–2030 window</li>
            <li>Address to investors and strategic partners</li>
          </ul>
  ...
  <div class="modal" id="excerptModal">
    <div class="modal-box">
      <div class="modal-head">
        <h3>📄 ZARIF 2025 — Book 5 Excerpt</h3>
  ...
  <script>
    var EXCERPT_PDF = "https://zarif1961-blip.github.io/zarif-books/ZARIF_2025_Book_5_EXCERPT.pdf";
    ...
    document.getElementById('plisioPayBtn').addEventListener('click', function() {
      ...
      var plisioUrl = PLISIO_BASE_URL + '?order_number=' + encodeURIComponent(email + '::book_5');
